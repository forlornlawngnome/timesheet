...
class WeeksControllerTest < ActionController::TestCase
  ...
  test "should create week" do
    assert_difference('Week.count') do
      post :create, week: { season: @week.season, week_end: @week.week_end, week_start: @week.week_start, year_id: @week.year_id }
    end
  ...
  test "should update week" do
    patch :update, id: @week, week: { season: @week.season, week_end: @week.week_end, week_start: @week.week_start, year_id: @week.year_id }
    assert_redirected_to week_path(assigns(:week))
  end
